...
def create_candidate(request):
    ...
    if serializer.is_valid():
       ...
       candidate_data = {
        ...
        "resume_name": data["resume"].name   # ✅ store only file name
      }

       candidates.append(candidate_data)

       return Response({"message":"Candidate created successfully","id":candidate_data["id"]},status=status.HTTP_201_CREATED)
